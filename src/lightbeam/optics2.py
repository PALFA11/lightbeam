...
class scaled_cyl(OpticPrim):
    ...
    def __init__(self,xy,r,z_ex,n,nb,z_offset=0,scale_func=None,final_scale=1, fxy = None):
        ''' Initialize a scaled cylinder, where the cross-sectional geometry along the object's 
            ...
            fxy - final location of the center of the cylinder at z_ex.
        ...
        if fxy.all() != None:
            self.p2 = [fxy[0], fxy[1], z_ex + z_offset]
        else:
